                ...
                @foreach($arenas as $arena)
                    <div class="col-lg-4 mb-5">
                        <div class="card" style="width: 18rem;">
                            @if($arena->photo)
                            <img src="{{ asset('storage/' . $arena->photo->id . '/' . $arena->photo->file_name) }}" class="card-img-top" alt="...">
                        @endif
                        <div class="card-body">
                            ...
                            <a href="{{ route('booking', ['number' => $arena->number]) }}" class="btn btn-primary"
                                @auth
                                    {{-- Jika pengguna sudah login, tidak perlu ada perubahan --}}
                                @else
                             ...
                             @auth
                                 {{-- Tambahkan form untuk submit secara otomatis ketika pengguna belum login --}}
